...
TRUE_REWARDS = {"green": 2, "red": 0,  "blue": -2, "spotted": 1, "striped": 0, "plain": -1}
...
EXP_DESCRIPTIONS = [{"type": "description", "feature": utt[0], "value": utt[1]}
                    for utt in itertools.product(["green", "spotted", "plain", "blue"], [-2, -1, 1, 2])]
